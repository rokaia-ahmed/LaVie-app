...
import 'package:plants_app/models/tools_model.dart';
...
class ToolItem extends StatelessWidget {
  const ToolItem({Key? key}) : super(key: key);
  @override
    ...
    return BlocConsumer<HomeCubit,HomeStates>(
      ...
      builder:(context,state){
        ...
        return BuildCondition(
          condition:(cubit.toolsList.isNotEmpty) ,
          builder:(context)=> GridView.builder(
            ...
            itemBuilder: (context,index)=>BuildItem(model: cubit.toolsList[index],cubit: cubit),
          ),
